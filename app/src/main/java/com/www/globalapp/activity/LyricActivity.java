...
import com.www.globalapp.lrc.view.ILrcBuilder;
import com.www.globalapp.lrc.view.ILrcView;
import com.www.globalapp.lrc.view.ILrcViewListener;
import com.www.globalapp.lrc.view.impl.DefaultLrcBuilder;
...
public class LyricActivity extends BaseActivity {
    public final static String TAG = "LyricActivity";
...
//设置自定义的LrcView上下拖动歌词时监听
    ...
    protected void initView() {
        mLrcView = (ILrcView) findViewById(R.id.lrvview_lyricac);
    }
    ...
    public void beginLrcPlay() {
        ...
        try {
            ...
            e.printStackTrace();
            Log.e(TAG, e.toString() + "---2");
        } catch (IOException e) {
            e.printStackTrace();
            Log.e(TAG, e.toString() + "---3");
        }
    }
    ...
    class LrcTask extends TimerTask {
        ...
        public void run() {
            ...
            LyricActivity.this.runOnUiThread(new Runnable() {
                public void run() {
                    //滚动歌词
